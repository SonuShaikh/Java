...
{ 
String msg = " A Simple Moving Banner."; Thread t = null; int state; boolean stopFlag;
...
// Display banner
 for( ; ; ) { try { repaint(); Thread.sleep(250); ch = msg.charAt(0); msg = msg.substring(1, msg.length()); msg += ch; if(stopFlag) break; } catch(InterruptedException e) {} }
}
// Pause the banner. 
